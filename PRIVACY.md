...
## What Goggles processes

To provide its features, Goggles reads media elements and related page information such as image descriptions, filenames, captions, links, and nearby titles. This processing happens on your device and is used only to frost media, show available descriptions, and identify likely blocked-subject matches.
...
These settings remain in your Chrome profile until you change them, clear the extension's data, or uninstall Goggles.

## Data collection and sharing

Goggles does not:

- transmit page content, images, browsing activity, or settings to the developer;
- use analytics, advertising, tracking pixels, or a developer-operated server;
...
Goggles uses Chrome permissions only to provide its stated features:
...
Goggles does not download or execute remote JavaScript or WebAssembly. All extension code is included in the installed package.
...
Questions or privacy concerns can be submitted through the [Goggles GitHub repository](https://github.com/superlowburn/Goggles/issues).
